        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Sign in to your ZaleN-Gam account
            </p>
          </CardHeader>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" className="pl-10" required />
                </div>
              </div>
